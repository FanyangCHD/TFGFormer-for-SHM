...
parser.add_argument('--save_path', default='../TFGFormer/CantonTower/Experiment', type=str, help='save path')
...
#####     Canton Tower Dataset Path            #####
train_input = "../SHM_Data/Canton Tower/benchmark/train/feature"
train_label = "../SHM_Data/Canton Tower/benchmark/train/label"
val_input = "../SHM_Data/Canton Tower/benchmark/val/feature"
val_label = "../SHM_Data/Canton Tower/benchmark/val/label"
